...
function generate_terrain()
   ...
   for i = 1, #lvl.up - 2, 2 do
      ...
      if (down_y-up_y) > 20 and x % 128 == 0 and randx(3) > 1 then
         local oy  = up_y - 4
         local obj = make_obj(
            { y=oy, x=x, from=oy, to=down_y, frames=40, alive=true, cb=function(o) o.alive=false end }
         )
         add(objects, obj)
      end
   end
...
function _update()
   ...
   for obj in all(objects) do
      if not obj.animating and obj.alive and on_screen(obj.x) and obj.x - (cam_x+player_x) < 60 then
         animate_move(obj)
      end
   end
end
...

