...
function animate_spinning_leaf()
   leaf = merge({
         x=8,
         y=8,
         sprite=1,
...
function _draw()
   ...
   spr_rotate(leaf.x, leaf.y, leaf.rot,  0.5, 0.5, 2, false, 1)
end

-- draw_rotated_square(16, 96, rot,  0, 0, 1)
-- draw_rotated_rect(94, 32, rot, 10, 1, 4, 2)

-- draw_rotated_tile(32, 32, rot,  6, 1, 2,false,3)
-- draw_rotated_tile(48, 96, rot,  0, 8, 4,false,1)
-- draw_rotated_tile(96, 96, rot,  0, 8, 4,true,1.5)
...
__gfx__

