...
function animate_snowflake(p)
   while p.y < 126 do
      ...
      if p.fluttering then
         -- 5 sprite changes to go: 1,2,3,4,1
         if nth_frame(p.fluttering/5, p.flutter) then
            p.sprite = 4+ (1+p.sprite % 4)
         end
         p.flutter += 1
...
__gfx__

